...
void playerTeamSettings() {
	...
	/*if(gameMode != classify::Simulation) {
		...
		switch(teamselected) {
		case '0':
			options::firstTeamType = classify::Student;
			options::secondTeamType = classify::Teacher;
			break;
		case '1':
			options::firstTeamType = classify::Teacher;
			options::secondTeamType = classify::Student;
			break;
		}
	}
	else {
